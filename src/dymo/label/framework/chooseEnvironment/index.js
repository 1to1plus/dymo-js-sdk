...
const chooseEnvironment = function (envCheckResult) {
  ...
  if (svc) {
    ...
    _framework.printLabelAsync = function (
      printerName, printParamsXml, labelXml, labelSetXml) {
      return svc.printLabelAsync(printerName, printParamsXml, labelXml,
        labelSetXml)
    }
    _framework.printLabel2Async = function (
      printerName, printParamsXml, labelXml, labelSetXml) {
      return svc.printLabel2Async(printerName, printParamsXml, labelXml,
        labelSetXml)
    }
